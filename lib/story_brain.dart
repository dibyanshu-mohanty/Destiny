...
class Content{
 ...
 Story(
  ...
  void nextStory(int c){
    if (c==1 && _storyNum==0){
      _storyNum=1;
    } else if (c==2 && _storyNum==0){
      _storyNum=2;
    } else if (c==1 && _storyNum==1){
      _storyNum=2;
    } else if (c==2 && _storyNum==1){
      _storyNum=3;
    } else if (c==1 && _storyNum==2){
      _storyNum=5;
    } else if (c==2 && _storyNum==2){
      _storyNum=4;
    } else if(c==1 && _storyNum==3 || _storyNum==4 || _storyNum==5){
      restart();
    }
  }
  void restart(){
  ...
  String mainStory(){
    return _content[_storyNum].storyText;
  }
  String getChoice1(){
    return _content[_storyNum].choice1;
  }
  String getChoice2(){
    return _content[_storyNum].choice2;
  }
  bool buttonVisible(){
